...
- [Scaling Memory Search](initiatives/scaling-memory-search.md): lifecycle, consolidation, and indexing changes to keep `qmd` memory search relevant as the corpus grows
