...
- [Episode Transcription](initiatives/manual-transcripts.md): manually initiated and per-podcast opt-in on-device transcripts with timed segments and a persisted one-at-a-time queue, rendered read-only (tap-to-seek deferred to v2)
