...
- `SmartListConditionRow` — a leading Kind picker (Episode Title / Episode Description / Episode Title or Description / State / Tag / Duration / Publish Date); the trailing controls swap by Kind:
