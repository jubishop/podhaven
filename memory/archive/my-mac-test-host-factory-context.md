...
- [factory-v3-migration](../factory-v3-migration.md) — Factory v3 / FactoryTesting packaging.
- [build-variants-dev-debug-release](../build-variants-dev-debug-release.md) — Run = Development/`.dev`, Test = Debug/`.debug`, separate data dirs.
- [flaky-test-observation-restarts](flaky-test-observation-restarts.md) — parallel Swift Testing + DI timing family.
