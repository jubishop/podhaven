...
# Flaky test observation restarts
...
- [factory-v3-migration](../factory-v3-migration.md) — Factory v3 actor-isolation rules; the test target's `autoRegister` running on the cooperative pool is the same class of "spawned task inherits an unexpected execution context" issue.
