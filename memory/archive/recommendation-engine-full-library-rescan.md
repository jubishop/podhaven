...
# Recommendation engine full library rescan
...
- [podcast-detail-observation-storm](podcast-detail-observation-storm.md) — #293, the sibling bug: same
...
- [recommendation_sort_prewarming](recommendation-sort-prewarming.md) — recommendation behaviour the fix preserves.
