...
- [NowPlayingInfo desync bug](project_nowplaying_desync_bug.md) — iOS sends stale backward scrub ~33s after AirPods pause in background; 5 incidents, incident-3 fix did NOT hold (4/13, 4/16 recurrences)
