...
- [Memory-audit model selection](memory-audit-model-selection.md): Use DeepSeek V4.1 Flash for the semantic memory audit; evaluate future model changes on audit quality within the $0.20 run budget.
