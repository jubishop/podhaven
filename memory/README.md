...
- [Memory-audit model selection](memory-audit-model-selection.md): Use DeepSeek V4.1 Flash for the semantic memory audit with a $0.50 cost guard; evaluate future model changes on audit quality and measured cost.
