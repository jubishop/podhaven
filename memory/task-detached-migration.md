...
- [factory-v3-migration](factory-v3-migration.md) — actor-isolation rules for Factory-resolved types, where many `@MainActor` / cooperative-pool boundary issues surface.
