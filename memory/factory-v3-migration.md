...
- [observation-broadcast-viewmodel](observation-broadcast-viewmodel.md) — when `@DynamicInjected` resolves a `@Broadcasted` value through an `@Observable` computed property, observation can silently miss conditional views.
