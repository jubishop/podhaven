...
class AllFieldsPodcastViewModel:
  ...
  UnsavedQueueableSelectableListModel
{
  ...
  init(termPodcast: SearchedPodcastByTerm) {
    self.searchText = termPodcast.searchText
    self.unsavedPodcast = termPodcast.unsavedPodcast
