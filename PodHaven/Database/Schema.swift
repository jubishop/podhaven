...
enum Schema {
  ...
  static func makeMigrator() -> DatabaseMigrator {
    ...
    migrator.registerMigration("v64", migrate: migrateV64)
    migrator.registerMigration("v65", migrate: migrateV65)
    migrator.registerMigration("v66", migrate: migrateV66)
    migrator.registerMigration("v67", migrate: migrateV67)
    migrator.registerMigration("v68", migrate: migrateV68)
    migrator.registerMigration("v69", migrate: migrateV69)
    migrator.registerMigration("v70", migrate: migrateV70)
    migrator.registerMigration("v71", migrate: migrateV71)
    migrator.registerMigration("v72", migrate: migrateV72)
    migrator.registerMigration("v73", migrate: migrateV73)
    migrator.registerMigration("v74", migrate: migrateV74)
    migrator.registerMigration("v75", migrate: migrateV75)
    migrator.registerMigration("v76", migrate: migrateV76)
    migrator.registerMigration("v77", migrate: migrateV77)
    migrator.registerMigration("v78", migrate: migrateV78)
    migrator.registerMigration("v79", migrate: migrateV79)
    migrator.registerMigration("v80", migrate: migrateV80)
    migrator.registerMigration("v81", migrate: migrateV81)
    migrator.registerMigration("v82", migrate: migrateV82)
    migrator.registerMigration("v83", migrate: migrateV83)
    return migrator
  }
}
