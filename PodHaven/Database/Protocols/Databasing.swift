...
protocol Databasing: Sendable {
  ...
  /// Notifies the database about changes to podcast and episode tables for the given podcast ID
  /// This triggers Observatory notifications for any observers watching these tables
