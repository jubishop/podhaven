...
class DisplayedPodcastTests {
  ...
  func forwardsFieldsFromUnsaved() throws {
    ...
    #expect(displayed.defaultPlaybackRate == unsavedPodcast.defaultPlaybackRate)
    #expect(displayed.queueAllEpisodes == unsavedPodcast.queueAllEpisodes)
    #expect(displayed.cacheAllEpisodes == unsavedPodcast.cacheAllEpisodes)
    #expect(displayed.notifyNewEpisodes == unsavedPodcast.notifyNewEpisodes)
    #expect(displayed.freshnessCadence == unsavedPodcast.freshnessCadence)
  ...
  func forwardsFieldsFromSaved() async throws {
    ...
    #expect(displayed.defaultPlaybackRate == podcast.defaultPlaybackRate)
    #expect(displayed.queueAllEpisodes == podcast.queueAllEpisodes)
    #expect(displayed.cacheAllEpisodes == podcast.cacheAllEpisodes)
    #expect(displayed.notifyNewEpisodes == podcast.notifyNewEpisodes)
    #expect(displayed.freshnessCadence == podcast.freshnessCadence)
