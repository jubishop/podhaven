...
struct PublisherTranscriptTests {
  ...
  @Test("alternate Podcasting namespace prefixes are supported")
  func alternateNamespacePrefixIsSupported() async throws {
    let transcriptURL = URL(string: "https://example.com/episode.vtt")!
    let data = Data(
      """
      ...
      <rss xmlns:itunes="http://www.itunes.com/dtds/podcast-1.0.dtd"
           ...
           version="2.0">
        <channel>
          <title>Alternate Namespace Prefix</title>
          <description>Valid feed using a non-suggested Podcasting 2.0 prefix.</description>
          <link>https://example.com/podcast</link>
          <itunes:image href="https://example.com/podcast.jpg" />
          <item>
            <title>Episode</title>
            <guid>alternate-prefix</guid>
            <enclosure url="https://example.com/episode.mp3" type="audio/mpeg" />
            <pc:transcript url="\(transcriptURL.absoluteString)" type="text/vtt" language="en" />
          </item>
        </channel>
      </rss>
      """
