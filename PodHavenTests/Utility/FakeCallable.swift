...
protocol FakeCallable {
  var callOrder: ThreadSafe<Int> { get }
  var callsByType: ThreadSafe<[ObjectIdentifier: [any MethodCalling]]> { get }
}
...
extension FakeCallable {
  ...
  func recordCall<Parameters: Sendable>(
    ...
    callsByType { $0[key, default: []].append(call) }
  }

  func clearAllCalls() {
    callOrder(0)
    callsByType { $0.removeAll() }
  }
