...
@Suite("of v58 migration tests", .container)
class V58MigrationTests {
  ...
  @Test("v58 adds alwaysShowPodcastImage defaulting existing rows to false")
  ...
  @Test("v58 lets new rows opt into alwaysShowPodcastImage")
