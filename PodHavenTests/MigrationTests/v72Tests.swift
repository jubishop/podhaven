...
struct V72MigrationTests {
  ...
  @Test("v72 removes obsolete keys and normalizes legacy strings")
  func removesAndNormalizes() throws {
    try migrator.migrate(appDB.unsafeTestDB, upTo: "v71")
    let defaults = try defaults()
    defaults.set(Data("[]".utf8), forKey: "transcriptionQueue")
  ...
  @Test("v72 preserves values already stored as JSON Data")
