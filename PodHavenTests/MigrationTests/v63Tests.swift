...
class V63MigrationTests {
  ...
  private func seedEpisodeAtV62() async throws {
  ...
  @Test("v63 adds a nullable transcript column, NULL for existing episodes")
  func addsNullableTranscriptColumn() async throws {
    try await seedEpisodeAtV62()
  ...
  @Test("v63 stores timed-segment transcript JSON")
