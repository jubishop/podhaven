...
class V53MigrationTests {
      ...
      try db.execute(
        sql: """
          INSERT INTO podcast (
            ...
            600, 'https://example.com/v53.xml', 'V53 Podcast',
  ...
  @Test("v53 adds a NOT NULL playbackStarted column defaulting to false")
  ...
  @Test("v53 backfills playbackStarted from currentTime > 0")
