...
@Suite("v33 migration tests (embedding cache tables)", .container)
class V33MigrationTests {
  @DynamicInjected(\.appDB) private var appDB

  @Test("v33 creates episodeEmbedding table with correct columns")
  ...
  @Test("v33 creates podcastEmbedding table with correct columns")
