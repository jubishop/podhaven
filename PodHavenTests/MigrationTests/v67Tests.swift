...
@Suite("of v67 migration tests", .container)
class V67MigrationTests {
  ...
  private func seedEpisodeAtV66() async throws {
      ...
      try db.execute(
        sql: """
          INSERT INTO podcast (
            ...
            700, 'https://example.com/v66.xml', 'V66 Podcast',
  ...
  @Test("v67 adds a nullable transcript column, NULL for existing episodes")
  func addsNullableTranscriptColumn() async throws {
    try await seedEpisodeAtV66()
  ...
  @Test("v67 stores timed-segment transcript JSON")
