...
- No external refs in production code comments — issues/PRs (e.g., `#262`), docs (`see foo.md`), memories, Slack threads, etc. They move or disappear; context belongs in the commit/PR. Tests are exempt.
